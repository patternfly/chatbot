...
import { ActionGroup, Button, Form, FormProps, TextInput } from '@patternfly/react-core';
...
const MessageInput: React.FunctionComponent<MessageInputProps> = ({
  ...
  return (
    <Form {...props}>
      <TextInput placeholder={editPlaceholder} value={messageText} onChange={onChange}></TextInput>
